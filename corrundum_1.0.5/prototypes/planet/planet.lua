local planet_map_gen = require("__corrundum__.prototypes.planet.corrundum-map-gen")
local asteroid_util = require("__space-age__.prototypes.planet.asteroid-spawn-definitions")
local planet_catalogue_corrundum = require("__corrundum__.prototypes.planet.procession-catalogue-corrundum")

--local planet_map_gen = require("__corrundum__/planet/corrundum-map-gen")
...
data:extend(
{
    -------------------------------------------------------------------------- LOCATIONS
    {
        type = "planet",
        name = "corrundum",
        icon = "__corrundum__/graphics/icons/corrundum-icon.png",
        starmap_icon = "__corrundum__/graphics/icons/starmap-planet-corrundum.png",
        ...
        order = "k[corrundum]",
        subgroup = "planets",
        map_gen_settings = planet_map_gen.corrundum(), 
        pollutant_type = nil,
        ...
        procession_graphic_catalogue = planet_catalogue_corrundum,
        surface_properties =
        {
